...
OUTPUT_CSV="${1:-/home/rsalman/cusparse-experiments/sweep_bsr_results.csv}"
touch "$OUTPUT_CSV"
echo "Registry,Case,M,K,N,R,C,NNZ_Blocks,Avg_ms,Avg_TFLOPs,Max_TFLOPs,Avg_GBs,Max_GBs" > "$OUTPUT_CSV"

for REG in 8 9 10 11; do
    echo "Running Registry $REG ..."
    OUTPUT=$(./spmm_bsr_fp16 $REG)
    echo "$OUTPUT"
    ...
    while IFS= read -r line; do
        ...
        echo "$REG,$CASE,$M,$K,$N,$R,$C,$NNZ,$AVG_MS,$AVG_TFLOPS,$MAX_TFLOPS,$AVG_GBS,$MAX_GBS" >> "$OUTPUT_CSV"
